...
public class Base64Utils {
    ...
    private static void writeChars(File file, char[] data) throws IOException {
	 ...
	 public static void main(String[] args) throws UnsupportedEncodingException {
	     ...
	     String sourse="eyJhIjoxMDAsIm5hbWUiOiJ6b3UifQ==";
//	     String encryString =base64.encode(sourse);//加密
	     String decryString =base64.decode(sourse);//解密
	     System.out.println(sourse+"Base64解密后为:"+decryString);
	}
}
